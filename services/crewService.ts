...
const ROLE_TASKS: Record<string, { task_key: string; title: string; description: string; is_required: boolean; proof_required: boolean }[]> = {
  default: [
    ...
    { task_key: 'create_pulse_post', title: 'Create a post in DAWEN Pulse', description: 'Write a genuine post in DAWEN Pulse (the social feed). It can be about crypto, trading, DAWEN, or anything relevant to the community. Submit a link to your post or a screenshot as proof.', is_required: false, proof_required: true },
    { task_key: 'get_verified', title: 'Get your DAWEN account verified', description: 'Complete the free blue badge verification in Settings → Get Verified (Free). Follow the 4 required accounts and DM "Blue" to @BlueBadge. Submit when your badge is active.', is_required: false, proof_required: false },
  ],
  raider: [
