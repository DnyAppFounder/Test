...
export default function ImportWallet() {
  ...
  const handleImport = async () => {
    ...
    try {
      ...
      console.log('[Dawen Import Debug] Seed phrase word count:', words.length);
      console.log('[Dawen Import Debug] Solana address:', debugAddrs.solana);

      const accounts = await walletManager.createWallet(trimmed);

      console.log('[Dawen Import Debug] Created accounts:');
      accounts.forEach(a => {
